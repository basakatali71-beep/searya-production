...
export const SearyaApi = {
  ...
  contacts: () => request('/api/account/contacts'),
  saveContact: data => request('/api/account/contacts', { method: 'POST', body: data }),
  deleteContact: id => request(`/api/account/contacts/${encodeURIComponent(id)}`, { method: 'DELETE' }),
  catalogItems: () => request('/api/account/catalog-items'),
  saveCatalogItem: data => request('/api/account/catalog-items', { method: 'POST', body: data }),
  deleteCatalogItem: id => request(`/api/account/catalog-items/${encodeURIComponent(id)}`, { method: 'DELETE' }),
