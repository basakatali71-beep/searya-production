...
function documentValues() {
  ...
  return {type:$('#doc-type').value,number:$('#doc-number').value.trim(),business:$('#business-name').value.trim(),businessEmail:$('#business-email').value.trim(),client:$('#client-name').value.trim(),clientEmail:$('#client-email').value.trim(),issueDate:$('#issue-date').value,dueDate:$('#due-date').value,currency:normalizeCurrency(currency),items,subtotal,discountRate,discount,taxRate,tax,total:subtotal-discount+tax,notes:$('#doc-notes').value.trim(),logo:documentLogoData};
}
