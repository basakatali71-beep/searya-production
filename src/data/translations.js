export const translations = {
  tr: {
    ...
    // Top Banner & Vision
    bannerNew: "🔥 YENİ",
    bannerText: "aktif! Bütçenizi yazın, satıcılar size ulaşsın.",
    bannerAction: "İlan Oluştur →",
    visionPill: "Dijital ürünler için güvenli ve doğrudan devir pazaryeri",
    ...
    statListingsVal: "Seçilmiş",
    statListings: "Proje Keşfi",
    statDealsVal: "Doğrudan",
    statDeals: "Alıcı–Satıcı İletişimi",
    ...
    obQuote: "Yarım kalan projenizi rafa kaldırmak yerine doğru alıcıyla buluşturun.",
    ...
    simplePricing: {
      kicker: "Lansmana özel ücretsiz",
      title: "Projeni yayınla, doğru kişiyle bağlantı kur.",
      subtitle: "Searya lansman döneminde ücretsiz. Kredi kartı gerekmez ve satıştan komisyon alınmaz.",
      buyerRole: "ALICI",
      sellerRole: "SATICI",
      buyerTab: "Alıcıyım",
      sellerTab: "Satıcıyım",
      freeTitle: "Ücretsiz Alıcı Hesabı",
      freeDesc: "Projeleri keşfet ve sahipleriyle görüş",
      freePeriod: " yeni bağlantı / 30 gün",
      freeFeatures: ["Tüm ilanları incele", "10 yeni satıcı görüşmesi", "Mevcut sohbetlerde sınırsız mesaj", "Proje Arıyorum ilanı aç"],
      ...
      sellerFreeTitle: "Ücretsiz Satıcı Hesabı",
      sellerFreeDesc: "Projelerini profesyonel biçimde sergile",
      sellerFreePeriod: " aktif ilan",
      sellerFreeFeatures: ["3 aktif proje ilanı", "Alıcı mesajlarını ücretsiz al", "İlanlarını düzenle veya sil", "Satış komisyonu yok"],
      sellerFreeButton: "Ücretsiz İlan Ver",
      standardTitle: "3 İlan Paketi",
      standardDesc: "Yeni projelerini satışa çıkar",
      standardPeriod: " / tek seferlik",
      standardFeatures: ["3 proje ilanı yayınlama", "Sınırsız alıcı mesajı", "İlan kredilerinin süresi dolmaz", "Satış komisyonu yok"],
      standardButton: "3 İlan Satın Al",
      verifiedBadge: "Lansman fiyatı",
      verifiedTitle: "Satıcı Pro",
      verifiedDesc: "Daha fazla ilan ve güven araçları",
      verifiedPeriod: " / tek seferlik",
      verifiedFeatures: ["10 proje ilanı", "1 doğrulama incelemesi", "1 ilan için 7 gün öne çıkarma", "Kredilerin süresi dolmaz"],
      verifiedButton: "Satıcı Pro'ya Geç",
      verificationNote: "Doğrulama rozeti satın alınamaz; yalnızca inceleme kriterlerini geçen ilanlara verilir.",
      chatTitle: "Güvenli Başlangıç",
      chatDesc: "Kontrollü bağlantı, sınırsız devam",
      chatFeatures: ["İlk 6 mesajda iletişim bilgisi koruması", "Şikâyet ve kullanıcı engelleme", "Yönetici ilan incelemesi"],
      exploreButton: "İlanları Keşfet",
      note: "Lansman döneminde ücretsiz · Kart gerekmez · Satıştan komisyon alınmaz"
    },
    ...
    footerLinkContract: "Şablon Devir Sözleşmesi",
    ...
    footerRights: "© 2026 Searya. Tüm hakları saklıdır.",
  ...
  en: {
    ...
    // Top Banner & Vision
    bannerNew: "🔥 NEW",
    bannerText: "is live! Specify your budget and let sellers reach you.",
    bannerAction: "Create Listing →",
    visionPill: "A secure, direct-transfer marketplace for digital products",
    heroTitleLine1: "The 0% Commission Marketplace",
    heroTitleLine2: "for Digital Projects & SaaS",
    heroSubtitle: "Direct Founder-to-Buyer Messaging with Zero Transaction Fees",
    statListingsVal: "Curated",
    statListings: "Project Discovery",
    statDealsVal: "Direct",
    statDeals: "Buyer–Seller Contact",
    ...
    simplePricing: {
      kicker: "Free during launch",
      title: "Publish your project and connect with the right person.",
      subtitle: "Searya is free during launch. No card is required and no sales commission is charged.",
      buyerRole: "BUYER",
      sellerRole: "SELLER",
      buyerTab: "I'm a buyer",
      sellerTab: "I'm a seller",
      freeTitle: "Free Buyer Account",
      freeDesc: "Explore projects and talk to their owners",
      freePeriod: " new connections / 30 days",
      freeFeatures: ["Browse every listing", "10 new seller conversations", "Unlimited messages in existing chats", "Post Looking to Buy requests"],
      ...
      sellerFreeTitle: "Free Seller Account",
      sellerFreeDesc: "Present your projects professionally",
      sellerFreePeriod: " active listings",
      sellerFreeFeatures: ["3 active project listings", "Receive buyer messages for free", "Edit or delete your listings", "No sales commission"],
      sellerFreeButton: "Post Free Listing",
      standardTitle: "3 Listing Pack",
      standardDesc: "List your next digital projects",
      standardPeriod: " / one-time",
      standardFeatures: ["Publish 3 project listings", "Unlimited buyer messages", "Listing credits never expire", "No sales commission"],
      standardButton: "Buy 3 Listings",
      verifiedBadge: "Launch price",
      verifiedTitle: "Seller Pro",
      verifiedDesc: "More listings and trust tools",
      verifiedPeriod: " / one-time",
      verifiedFeatures: ["10 project listings", "1 verification review", "7-day boost for one listing", "Credits never expire"],
      verifiedButton: "Get Seller Pro",
      verificationNote: "Verification badges cannot be purchased; they are granted only to listings that pass review.",
      chatTitle: "A Safer Start",
      chatDesc: "Controlled introductions, unlimited follow-up",
      chatFeatures: ["Contact details protected for the first 6 messages", "Reporting and user blocking", "Admin listing review"],
      exploreButton: "Explore Listings",
      note: "Free during launch · No card required · No sales commission"
    },
    ...
    footerLinkContract: "Transfer Agreement Template",
