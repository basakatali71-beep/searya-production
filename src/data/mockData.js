const baseForSaleListings = [
  {
    ...
    shortDescEn: "GPT-4o powered e-commerce and marketing copy platform for merchants and agencies.",
...
const saleStageOverrides = {
  ...
  "proj-3": { askingPrice: 350, mrr: 0, status: "MVP", statusEn: "MVP", isAnonymous: false, shortDesc: "Manifest V3 tabanlı sekme yöneticisinin çalışan MVP'si; mağaza yayını ve premium özellikleri tamamlanmadı.", shortDescEn: "Working Manifest V3 tab manager MVP with a clear roadmap for store release and premium features.", seller: { name: "Mert Kaya", handle: "@mertbuilds", githubVerified: false } },
  ...
  "proj-6": { askingPrice: 750, mrr: 0, status: "MVP", statusEn: "MVP", shortDesc: "Fatura oluşturma ve otomatik hatırlatma akışları hazır; çoklu para birimi ve ödeme entegrasyonu eksik.", shortDescEn: "Invoice creation and reminders are ready, with multi-currency and payment features on the roadmap." },
  ...
  "proj-9": { askingPrice: 900, mrr: 0, status: "MVP", statusEn: "MVP", shortDesc: "Dil bilgisi düzeltme uzantısının temel motoru çalışıyor; mağaza görselleri ve üyelik sistemi eksik.", shortDescEn: "Core grammar extension is working, with store assets and subscriptions planned for the next release." },
  ...
  "proj-12": { askingPrice: 3900, mrr: 0, status: "Yayında", statusEn: "Launched", shortDesc: "Form ve anket ürünü yayında; ödeme duvarı ile gelişmiş raporlama modülü tamamlanmadı.", shortDescEn: "Forms and surveys product is live, with paywall and advanced reporting features on its roadmap." },
...
const additionalWtbListings = [
  createWtbListing({ id: "wtb-10", title: "Yarım Kalmış SaaS MVP Arıyorum", titleEn: "Looking for a Small SaaS Product", budget: 700, category: "saas", categoryEn: "Micro SaaS", buyer: "Melis Tan", description: "Tasarımı ve temel akışları hazır, ödeme sistemi tamamlanmamış küçük SaaS projeleriyle ilgileniyorum.", descriptionEn: "Interested in focused SaaS products with a clear design, working core flows and growth potential.", tech: "Next.js, React or Vue", requirement: "Gelir şartı yok", requirementEn: "No revenue required", createdAt: "20 dakika önce", createdAtEn: "20 minutes ago" }),
  createWtbListing({ id: "wtb-11", title: "Chrome Extension MVP Satın Almak İstiyorum", titleEn: "Looking to Buy a Chrome Extension", budget: 1200, category: "extension", categoryEn: "Chrome Ext", buyer: "Emir Korkmaz", description: "Manifest V3 uyumlu, çalışan fakat mağazaya yüklenmemiş verimlilik uzantıları arıyorum.", descriptionEn: "Looking for working Manifest V3 productivity extensions with a clear path to store distribution.", tech: "JavaScript, TypeScript, Manifest V3", requirement: "Gelir veya kullanıcı şartı yok", requirementEn: "No revenue or user requirement", createdAt: "2 saat önce", createdAtEn: "2 hours ago" }),
  createWtbListing({ id: "wtb-12", title: "Mobil Uygulama Şablonu veya MVP Arıyorum", titleEn: "Looking for a Mobile App Template or MVP", budget: 1000, category: "mobile", categoryEn: "Mobile App", buyer: "Dila Öz", description: "Sağlık, eğitim veya üretkenlik alanında mağazaya çıkmamış Flutter ve React Native projeleri arıyorum.", descriptionEn: "Seeking unpublished Flutter or React Native projects in health, education or productivity.", tech: "Flutter or React Native", requirement: "Gelir şartı yok", requirementEn: "No revenue required", createdAt: "3 saat önce", createdAtEn: "3 hours ago" }),
